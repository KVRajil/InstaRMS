 ...
 * @author RAJIL KV
 */
public class Semester_principal_accepted {

    public Semester_principal_accepted() {
    String host="jdbc:mysql://localhost:3306/requestdb?zeroDateTimeBehavior=convertToNull";
                ...
                try {
                      ...
                      String  query="insert into semesterprincipalacceptdb(BRANCH,SEMESTER,ROLLNUMBER,NAME,ADMISSIONNUMBER,YEAROFADMISSION,PARENT,ADDRESS,RESIDENCE,LIBRARY,WORKSHOP,OFFICE,DEPARTMENT,FEE) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
