 ...
 * @author RAJIL KV
 */
class Railway_display_hod extends JFrame{
    public ResultSet res;
    public JTable table ;
    JLabel jl;

    public Railway_display_hod() {
    ...
    public static void main(String[] args) throws SQLException {
        Railway_display_hod rd = new Railway_display_hod();
    }

    private void Display() {
        
        MyModel_2 data = new MyModel_2();
  ...
  public void mouseClicked(MouseEvent e) {
    if (e.getClickCount() == 1) {
      ...
      ((MyModel_2) table.getModel()).deleteRow(row);
    }
  }
});
