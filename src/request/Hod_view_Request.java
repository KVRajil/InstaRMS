 ...
 * @author RAJIL KV
 */
public class Hod_view_Request extends JFrame{
    public static Railway_display_hod railway_display_hod;
    public static Document_display_hod document_display_hod;
    public static Semester_display_hod semester_display_hod;
    public Hod_view_Request()
    {
        setSize(1000,600);
        ...
        public void actionPerformed(ActionEvent e) {
            setVisible(false);
            railway_display_hod = new Railway_display_hod();
        }});

doc_ret.addActionListener(new ActionListener() { 
        public void actionPerformed(ActionEvent e) { 
            setVisible(false);
            document_display_hod = new Document_display_hod(); 
        }});

sem_reg.addActionListener(new ActionListener() { 
        public void actionPerformed(ActionEvent e) { 
           setVisible(false);
           semester_display_hod = new Semester_display_hod();
        }});
    }
    ...
    private final Action back = new AbstractAction()
    {
        ...
        public void actionPerformed(ActionEvent e)
        {   setVisible(false);
            Hod_Choice request2 = new Hod_Choice();
