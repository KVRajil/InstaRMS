 ...
 * @author RAJIL KV
 */
public class Railway_display extends JFrame{
    public ResultSet res;
    public JTable table ;
    JLabel jl;
    
    public Railway_display() throws SQLException 
    {
        setSize(1000,600);
    ...
    public static void main(String[] args) throws SQLException {
        Railway_display rd = new Railway_display();
    }
    ...
    if (e.getClickCount() == 1) {
      ...
      int row = target.getSelectedRow();
        try {
            ...
            Logger.getLogger(Railway_display.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
  }
});
