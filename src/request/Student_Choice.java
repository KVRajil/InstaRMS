...
import JDBCcodes.Student_change_password;
...
import static request.Hod.branch_text;
import static request.Hod.password_text;
import static request.Hod.username_text;

/**
 *
 * @author RAJILKV
 */
public class Student_Choice extends JFrame
{
    ...
    setSize(1000,600);
        ...
        JButton new_request=new JButton(new ImageIcon(getClass().getResource("newreq.png")));
        jl.add(new_request);
        new_request.setBounds(200,100,377,61);
        
        JButton view_status=new JButton(new ImageIcon(getClass().getResource("viewst.png")));
        jl.add(view_status);
        view_status.setBounds(200,200,306,59);
        ...
        public void actionPerformed(ActionEvent e) {
         ...
         view_status.addActionListener(new ActionListener() { 
        public void actionPerformed(ActionEvent e) {
          setVisible(false);
