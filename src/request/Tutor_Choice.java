 ...
 * @author RAJIL KV
 */
public class Tutor_Choice extends JFrame{
    ...
    public Tutor_Choice() 
    {
        ...
        JButton manage_st=new JButton(new ImageIcon(getClass().getResource("managest.png")));
        jl.add(manage_st);
        manage_st.setBounds(200,200,377,56);
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          new Tutor_view_Request();
          setVisible(false);
          } 
        } );
        
        manage_st.addActionListener(new ActionListener() { 
        public void actionPerformed(ActionEvent e) {
