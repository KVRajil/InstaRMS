...
import JDBCcodes.Principal_signup;
import JDBCcodes.Principal_login;
import static request.Hod.login_password_text;
import static request.Hod.login_username_text;
/**
 *
 * @author RAJIL KV
 */
public class Principal extends JFrame {
    ...
    public Principal() 
    {
        ...
        final JLabel jl=new JLabel(new ImageIcon(getClass().getResource("immg.jpg")));
        final JLabel conf=new JLabel(new ImageIcon(getClass().getResource("imagebk2.jpg")));
       ...
       final JPasswordField pass1 = new JPasswordField();
        ...
        final JLabel jl2=new JLabel(new ImageIcon(getClass().getResource("sign_up2.jpg")));
