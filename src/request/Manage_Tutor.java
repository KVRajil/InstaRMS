 ...
 * @author RAJIL KV
 */
class Manage_Tutor extends JFrame{
    ...
    private final Action back = new AbstractAction()
    {
        ...
        public void actionPerformed(ActionEvent e)
        {   setVisible(false);
            Tutor_Choice std = new Tutor_Choice();
            std.setVisible(true);
    ...
    public static void main(String[] args) throws SQLException {
        Manage_Tutor rd = new Manage_Tutor();
    }

    private void Display() {
        MyModel_3 data = new MyModel_3();
  ...
  public void mouseClicked(MouseEvent e) {
    if (e.getClickCount() == 1) {
      ...
      ((MyModel_3) table.getModel()).deleteRow(row);
    }
  }
});
