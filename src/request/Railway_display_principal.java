 ...
 * @author RAJIL KV
 */
class Railway_display_principal extends JFrame{
    public ResultSet res;
    public JTable table ;
    JLabel jl;

    public Railway_display_principal() {
    setSize(1000,600);
    ...
    public static void main(String[] args) throws SQLException {
        Railway_display_principal rd = new Railway_display_principal();
    }

    private void Display() {
        
        MyModel_4 data = new MyModel_4();
  ...
  public void mouseClicked(MouseEvent e) {
    if (e.getClickCount() == 1) {
      ...
      ((MyModel_4) table.getModel()).deleteRow(row);
    }
  }
});
