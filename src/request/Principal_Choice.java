...
import JDBCcodes.Principal_change_password;
import JDBCcodes.Tutor_change_password;
...
public class Principal_Choice extends JFrame{
    ...
    public Principal_Choice() 
    {
        ...
        final JLabel jl2=new JLabel(new ImageIcon(getClass().getResource("princhange.jpg")));
        ...
        final JTextField newuser_sign=new JTextField();
        ...
        JButton manage_hod=new JButton(new ImageIcon(getClass().getResource("manageh.png")));
        jl.add(manage_hod);
        manage_hod.setBounds(200,200,391,62);
        ...
        public void actionPerformed(ActionEvent e) {
          setVisible(false);
          new Principal_view_Request();
          } 
        } );
        
        manage_hod.addActionListener(new ActionListener() { 
        public void actionPerformed(ActionEvent e) {
          setVisible(false);
          new Manage_hod();
          } 
       ...
       change_password.addActionListener(new ActionListener() { 
        ...
        public void actionPerformed(ActionEvent e) { 
            ...
            newusername_text=newuser_sign.getText();
    ...
    {
        Principal_Choice principal_Choice = new Principal_Choice();
