...
import JDBCcodes.Student_signup;
...
public class StudentLogin extends JFrame{
    ...
    public StudentLogin() 
    {
        ...
        final JLabel jl=new JLabel(new ImageIcon(getClass().getResource("iv.jpg")));
       ...
       final JPasswordField pass1 = new JPasswordField();
        ...
        jl.add(login1);
        login1.setBounds(400,410,180,45);
        //jl.setIconTextGap(-1000);
        //jl.setOpaque(true);
        
        final JLabel jl2=new JLabel(new ImageIcon(getClass().getResource("imagebk21.jpg")));
        ...
        public void actionPerformed(ActionEvent e) { 
            ...
            jl2.add(user_id);
            user_id.setBounds(130,28,180,30);
            user_id.setFont( new Font("Arial",Font.BOLD,15) );
            user_id.setBorder(new LineBorder(Color.black));
            
            
            jl2.add(user_sign);
            user_sign.setBounds(130,75,180,30);
            user_sign.setFont( new Font("Arial",Font.BOLD,15) );
            user_sign.setBorder(new LineBorder(Color.black));
            
            
            jl2.add(pass_sign);
            pass_sign.setBounds(130,123,180,30);
            pass_sign.setFont( new Font("Arial",Font.BOLD,18) );
            pass_sign.setBorder(new LineBorder(Color.black));
            
            
            jl2.add(repass_sign);
            repass_sign.setBounds(130,176,180,30);
            ...
            jl2.add(jcb1);
            jcb1.setBounds(130,226,180,30);
            
            String semester[]={"S1&S2","S3","S4","S5","S6","S7","S8"};
            jcb2=new JComboBox(semester);
            jl2.add(jcb2);
            jcb2.setBounds(130,276,180,30);
        ...
        public void actionPerformed(ActionEvent e) { 
            ...
            semester_text=(String)jcb2.getSelectedItem();
